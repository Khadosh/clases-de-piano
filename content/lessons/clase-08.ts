...
const lesson: Lesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      intro:
        "Cada paso hacia la derecha es una quinta arriba y un sostenido más; hacia la izquierda, una quinta abajo y un bemol más. Abajo del todo los dos caminos se encuentran y la misma tecla queda escrita de las dos maneras.",
    },
  ],
